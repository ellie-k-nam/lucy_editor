...
bool isNameStart(int x) =>
    isLetter(x) || x == char.DOLLAR || x == char.UNDERSCORE || x == char.HASH;
...
class Lexer {
  ...
  int getLineCount(int start, int end) {
    String value = new String.fromCharCodes(input.getRange(start, end));
    return value.split('\n').length;
  }
