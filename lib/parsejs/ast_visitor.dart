...
class BaseVisitor<T> implements Visitor<T> {
  ...
  T? visitSpreadElement(SpreadElement node) => defaultNode(node);
...
abstract class Visitor1<T, A> {
  ...
  T? visitSpreadElement(SpreadElement node, A arg);
...
class BaseVisitor1<T, A> implements Visitor1<T, A> {
  ...
  T? visitSpreadElement(SpreadElement node, A arg) => defaultNode(node, arg);
